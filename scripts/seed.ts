...
import { HomeSection, Product, Setting } from "../src/models";
...
async function seed() {
  ...
  const legacy: LegacyContent = JSON.parse(readFileSync(legacyPath, "utf-8"));
  ...
  console.log("Seed complete: settings, home sections, 3 products.");
  process.exit(0);
}
